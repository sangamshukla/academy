<nav class="navbar navbar-expand navbar-light topbar mb-4 static-top shadow">
    ...
    <h4 class="dashboard_title"><a style="text-decoration: none; color: black;"
    ...
    <form class="d-none d-sm-inline-block form-inline navbar-search">
        <div class="d-flex">
            <div class="input-group">
                ...
                <input type="text" class="serch_block bg-white form-control bg-light border-0 small"
                    placeholder="Type Your Search here" aria-label="Search" aria-describedby="basic-addon2" />
