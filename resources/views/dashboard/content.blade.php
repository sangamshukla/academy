...
<div class="row">
    ...
    <div class="col-xl-8 col-lg-7 text-center">
        ...
        <div>
            ...
            <button class="btn session_buycta btn btn_block text-capitalize my-2 my-sm-0"><a
                    href="{{ route('packages.details') }}" style="text-decoration: none"
                    class="btn session_buycta btn-info text-capitalize my-2 my-sm-0">Buy now</a></button>
        </div>
    </div>
    <div class="col-xl-4 col-lg-5">
        <div class="profile_details card py-4 px-4 text-center">
            <div class="profile">
                ...
                <p class="class_section">
                    <span>class:</span><span>{{ auth()->user()->student->classmaster->name ?? 'Not found' }}</span></p>
        ...
        <div class="col-lg-12 mb-4">
            <div class="card mb-4">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold cource_class_tile">Other Available Cources for Class
                        <span>{{ auth()->user()->student->classmaster->name ?? 'Not FOund' }}</span></span></h6>
                </div>
            </div>
            <div class="row">
                @php $i = 1; @endphp
