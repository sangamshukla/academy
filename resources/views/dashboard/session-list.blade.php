                        ...
                        <div class="tab-pane fade p-3" id="two" role="tabpanel" aria-labelledby="two-tab">
                            <div id="accordion">
                                ...
                                @endif
                                                    ...
                                                    <div>
                                                        <p class="subject_card">Subject</p>
                                                        <p class="card_subject_title1">{{$batch->batch->subject->name}}</p>
                                                    </div>
                                                    <div class="border-left first_left_border"></div>
                                                    <div>
                                                        <p class="subject_card">Join Now</p>
                                                ...
                                                <p class="date_text" style="margin-top: -9px;
                                                      margin-left: 81px;">{{ $batch->start_date_time->format('d M, Y H:i A') }}</p>
                                        ...
                                        <div id="collapse{{$batch->id}}" class="collapse" aria-labelledby="headingOne" data-parent="#accordion">
                                            <div class="card-body">
                                                <table class="table">
                                                    ...
                                                    <tr>
                                                        <td>Teacher</td>
                                                        <td>{{ $batch->batch->teacher->name }}</td>
                                                    </tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        &euro; {{ $payments->order_amount - $payments->paid_amount }}
                                                                                                    ...
                                                                                                    <tr>
                                                        <td colspan="2"><a href="{{route('home-work', ['id'=>$batch->id])}}">View Homework</a></td>
                                                    </tr>
                            ...
                            <div id="accordion" >
                                <div class="card mb-3">
                                    <div class="card-header" id="headingThree">
                                        ...
                                        <div id="collapse{{$session->id}}" class="collapse" aria-labelledby="headingOne" data-parent="#headingOne">
                                            <div class="card-body">
