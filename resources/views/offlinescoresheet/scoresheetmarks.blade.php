...
@section('content')
                        ...
                        <tbody>
                            ...
                            @forelse($students as $student)
                                    ...
                                    @foreach ($subject_full_marks as $subject_full_mark)
                                        ...
                                        @php
                                            $allowed = App\Http\Controllers\OfflineController::is_allowed($student->student->id, $week_id);
                                        @endphp
                                    @endforeach
                                    <td>
                                        <input type="checkbox" name="is_allowed" id="" @if ($allowed)
                                        checked
                            @endif>
                            </td>
                            <td>
                                ...
                                @else
                                    ...
                                    <a href="{{ route('offline-scoresheet-pdf', [$student->student->id, $week_id]) }}"><svg
                                    ...
                                    <a href="{{ route('offline-scoresheet-edit', [$student->student->id, $week_id]) }}"
                                        rel="modal:open">
                                        <svg width="25" height="24" viewBox="0 0 25 24" fill="none"
                                            xmlns="http://www.w3.org/2000/svg " onclick="edit()" class="edit1">
                                            <path
                                    ...
                                    <svg width="25" height="24" viewBox="0 0 25 24" fill="none"
                                        xmlns="http://www.w3.org/2000/svg" onclick="deletemark()" class="delete1">
    ...
    <script>
        $('#my_modal').on('show.bs.modal', function(e) {
            ...
            $(e.cur rentTarget).find('input[name="bookId"]').val(bookId);
        }); 
    </script>
@endsection
