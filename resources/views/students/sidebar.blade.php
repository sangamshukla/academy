 ...
 <ul class="student_dashboard navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
     ...
     <li class="nav-item active">
         <a class="nav-link" href="{{ route('student-dashboard') }}">
             <div class="nav_images"><img src="{{ asset('wa/dashboard/img/dasboard.svg') }}" /></div>
             <br />
             <span>Dashboard</span>
         </a>
     </li>
     ...
     <!-- Nav Item - Charts -->
     <li class="nav-item">
         <a class="nav-link" href="{{ route('packages.details') }}">
             <div class="nav_images"><img src="{{ asset('wa/dashboard/img/Online course.svg') }}" /></div>
             <br />
     ...
     <!-- Nav Item - Alerts -->
     <li class="nav-item">
         <a class="nav-link collapsed" href="{{ route('get-my-scoresheet') }}">
     ...
     <li class="nav-item dropdown no-arrow mx-1 pl-5">
         <a class="dropdown-toggle" href="#" id="alertsDropdown" role="button" data-toggle="dropdown"
